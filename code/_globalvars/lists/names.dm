...
GLOBAL_LIST_INIT(protogen_names, world.file2list("strings/names/protogen.txt"))
GLOBAL_LIST_INIT(plague_doctor_male_names, world.file2list("strings/names/plague_doctor_male.txt"))
GLOBAL_LIST_INIT(plague_doctor_female_names, world.file2list("strings/names/plague_doctor_female.txt"))
