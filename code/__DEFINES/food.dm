...
#define FOOD_QUALITY_NORMAL 2
#define FOOD_QUALITY_NICE 4
#define FOOD_QUALITY_GOOD 6
#define FOOD_QUALITY_VERYGOOD 8
#define FOOD_QUALITY_FANTASTIC 10
#define FOOD_QUALITY_AMAZING 12
#define FOOD_QUALITY_TOP 14
